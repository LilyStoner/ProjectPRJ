 ...
 * @author admin
 */
@WebServlet(name = "VehiclesDelete", urlPatterns = {"/VehiclesDelete"})
...
public class VehiclesDelete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String brandSearch = request.getParameter("search"); // Lấy thông tin tìm kiếm
        ...
        try {
            ...
            response.sendRedirect("Vehicle"); // Chuyển hướng nếu có lỗi
        }
