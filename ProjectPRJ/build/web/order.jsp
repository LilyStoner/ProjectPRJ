            ...
            <div class="vehicle-image">
                ...
                <form action="OrderComplete" method="POST">
                    ...
                    <div class="form-date">
                        ...
                        {%>
                            <input type="date" id="pickup_date" value="<%=pickupDate%>" name="pickup_date" oninput="validateDates(vehiclePricePerDay)" required >
                            <%}else {%>
                            <input type="date" id="pickup_date" name="pickup_date" oninput="validateDates(vehiclePricePerDay)"  >
                            <%}%>
                            <br>
                        ...
                        if(pickupDate!=null && !pickupDate.isBlank() && !pickupDate.isEmpty())
                        {%>
                            <input type="date" id="return_date" value="<%=returnDate%>" name="return_date" oninput="validateDates(vehiclePricePerDay)" required >
                            <%}else {%>
                            <input type="date" id="return_date" name="return_date" oninput="validateDates(vehiclePricePerDay)"  >
                            <%}%>
                            <br>
